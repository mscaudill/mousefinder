...
**Thank you for your interest in making MouseFinder better!**
...
https://github.com/mscaudill/mousefinder/blob/master/CODE_OF_CONDUCT.md) for
information on our rules of conduct.

## Creating an Issue

We have created [issue templates](
https://github.com/mscaudill/mousefinder/issues) for:

- Asking questions
- Filing bug reports
- Making feature requests
- Improving MouseFinder's documentation
...
1. Open an issue to discuss the changes you would like to see in MouseFinder.
2. Fork MouseFinder's master branch and create a local branch for your change.
